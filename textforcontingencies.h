...
#define WELL_SEPTIC_BUYER "For properties served by a well and septic system, you will need to have a separate inspection of those components performed by a specialist. Any water testing must be asked for in the Offer."
...
#define HOME_OWNER_INSSURENCE_BUYER "You should arrange for home owner's insurance as soon as the inspection is completed.  You will be required to pay the first year in full.  Please have your insurance agent send a copy of the paid insurance binder to your lender."
...
#define CLOSING_SELLER "You will need a valid driver's license and either a cashier's check or a wire transfer for any funds you will bring to closing. Roughly a week prior to closing, the title company will provide a closing disclosure to you.  The disclosure will list the funds you must bring to closing in order to close the transaction."
...
#define WELL_SEPTIC_SELLER "The buyer will need to have a separate inspection of the well and/or septic system performed by a specialist. Any water testing must be asked for in the offer."
...
#define HOA_DOCS_DELIVERY_SELLER "You are required to deliver these to the buyer. Home Owner’s documents may include association bylaws, meeting minutes, budgets, and a reserve funds statement."
#define HOA_DOCS_REVIEW_SELLER "This is the buyer’s opportunity to look over all the home owner’s association documentation. During this time, the buyer has the ability to object to items contained within the documents and possibly end the purchase contract."
